...
function peg$parse(input, options) {
  ...
  const peg$e23 = peg$classExpectation(["e", "E"], false, false, false);
  const peg$e24 = peg$literalExpectation("true", false);
  const peg$e25 = peg$literalExpectation("false", false);
  const peg$e26 = peg$literalExpectation("null", false);
  ...
  const peg$e35 = peg$literalExpectation("t", false);
  ...
  function peg$f1(test, consequent, alternate) {
    return {
  ...
  function peg$f9(operator, argument) {
    return {
  ...
  function peg$f10(head, args) {    return { type: 'call', args: args || [] };  }
  function peg$f11(head, prop) {    return { type: 'member', property: prop, computed: true };  }
  function peg$f12(head, prop) {    return { type: 'member', property: prop, computed: false };  }
  ...
  function peg$f15(expr) {    return expr;  }
  function peg$f16(raw) {
    return {
      type: 'Literal',
  ...
  function peg$f17() {    return { type: 'Literal', value: true, raw: 'true' };  }
  function peg$f18() {    return { type: 'Literal', value: false, raw: 'false' };  }
  function peg$f19() {    return { type: 'Literal', value: null, raw: 'null' };  }
  ...
  function peg$parseReservedLiteral() {
    let s0, s1, s2, s3;
